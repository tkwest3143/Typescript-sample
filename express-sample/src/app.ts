...
import { getCustomRepository, createConnection, Index, Connection } from "typeorm";
...
export class App {
    ...
    public router() {
        ...
        this.app.get('/users/:id', async (req: express.Request, res: express.Response) => {
            const connection = await createConnection();
            const userRepository = getCustomRepository(UserRepository);
        ...
        //edit user
        this.app.post('/users/:id', async (req: express.Request, res: express.Response) => {
            const connection = await createConnection();
            const userRepository = getCustomRepository(UserRepository);
            const results = await userRepository.findOne(req.params.id);
            console.log(results)
        ...
        // get Chat by room id
        this.app.get('/chats/:id', async (req: express.Request, res: express.Response) => {
            const connection = await createConnection();
        ...
        // get room by room id
        this.app.get('/room/:id', async (req: express.Request, res: express.Response) => {
            const connection = await createConnection();
        ...
        // create room
        this.app.get('/room/create', async (req: express.Request, res: express.Response) => {
            const connection = await createConnection();
            const roomRepository = connection.getRepository(Room);
            console.log("chat body" + req.body)
